      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center mb-16">
          ...
          <div className="bg-gradient-to-br from-[#e8eef4] to-[#d1dce8] rounded-lg p-12 flex items-center justify-center min-h-64">
            <div className="text-center">
              ...
              <p className="text-gray-600 mt-2">Desde 2024</p>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
          ...
          <div className="bg-white rounded-lg shadow-md p-8 hover:shadow-lg transition-shadow">
            ...
            <h3 className="text-2xl font-bold text-gray-900 mb-4">Pasión</h3>
            <p className="text-gray-600">
        ...
        <div className="bg-gradient-to-r from-[#e8eef4] to-[#f0f4f8] rounded-lg p-12 mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="flex gap-4">
              ...
              <div>
                <h3 className="text-xl font-bold text-gray-900 mb-2">Envío a Nivel Nacional</h3>
                <p className="text-gray-600">
            ...
            <div className="flex gap-4">
              <div className="text-3xl flex-shrink-0">💝</div>
              <div>
                <h3 className="text-xl font-bold text-gray-900 mb-2">Precios Competitivos</h3>
                <p className="text-gray-600">
            ...
            <div className="flex gap-4">
              <div className="text-3xl flex-shrink-0">💬</div>
              <div>
                <h3 className="text-xl font-bold text-gray-900 mb-2">Atención al Cliente 24/7</h3>
                <p className="text-gray-600">
        ...
        {/* Location Section */}
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center mb-16">
          <div className="bg-red-50 rounded-lg p-12 flex items-center justify-center min-h-64 border-2 border-red-200">
            <div className="text-center">
              <div className="text-8xl mb-4">📍</div>
              <h3 className="text-2xl font-bold text-gray-900 mb-4">Ubicación</h3>
              <p className="text-gray-600 text-lg">Chiclayo, Perú</p>
              <p className="text-gray-500 mt-2">Sirviendo a todo el país</p>
            </div>
          </div>
          <div>
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">
